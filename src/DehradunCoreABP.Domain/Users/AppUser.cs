...
namespace DehradunCoreABP.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update DehradunCoreABPDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update DehradunCoreABPEfCoreEntityExtensionMappings to extend the IdentityUser entity
